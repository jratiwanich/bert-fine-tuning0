...
It covers data preparation, model setup, training, and evaluation.
...
# 2. Load your dataset (replace 'your_data.csv' with your file)
df = pd.read_csv("your_data.csv")  # The CSV should have 'text' and 'label' columns
...
# 14. Save the model
model.save_pretrained("./custom_intent_model")
tokenizer.save_pretrained("./custom_intent_model")
print("Model and tokenizer saved to ./custom_intent_model")
